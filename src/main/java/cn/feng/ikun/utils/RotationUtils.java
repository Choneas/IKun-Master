...
public class RotationUtils {
    ...
    public static float[] getRotationsEntity(final EntityLivingBase entity) {
        if (PlayerUtils.isMoving()) {
            return getRotations(entity.posX + getRandomDoubleInRange(0.03, -0.03), entity.posY + entity.getEyeHeight() - 0.4 + getRandomDoubleInRange(0.07, -0.07), entity.posZ + getRandomDoubleInRange(0.03, -0.03));
        }
