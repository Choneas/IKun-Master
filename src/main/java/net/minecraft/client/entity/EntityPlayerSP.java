...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            Client.instance.eventManager.call(new EventUpdate(posX, posY, posZ, rotationYaw, rotationPitch, onGround));
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && (!Client.instance.moduleManager.getModule(NoSlow.class).isToggle())) {
