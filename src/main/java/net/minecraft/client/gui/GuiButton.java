...
public class GuiButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible) {
            ...
            HFontRenderer fontrenderer = Client.instance.fontLoaders.get("poppins", 16);
            ...
            fontrenderer.drawCenteredStringWithShadow(displayString, this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, j);
        }
    }
