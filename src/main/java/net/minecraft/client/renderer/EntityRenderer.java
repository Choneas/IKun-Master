...
import cn.feng.ikun.module.modules.combat.Reach;
import cn.feng.ikun.ui.gui.GuiMainMenu;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            if (this.mc.playerController.extendedReach()) {
                d0 = 6.0D;
                d1 = 6.0D;
            } else if (Client.instance.moduleManager.getModule(Reach.class).isToggle()) {
                // Client: Reach
                d0 = d1 = Reach.rangeValue.getValue();
            } else {
                if (d0 > 3.0D) {
                    flag = true;
                }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Client.instance.eventManager.call(new Event3D(partialTicks));
